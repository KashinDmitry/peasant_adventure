...
leather_helmet = Armor("HELMET", "leather helmet", 3, 'common', 2, 11, "leather helmet: common quality, required level: 3, armor: 2, costs 11 gold")
iron_helmet = Armor("HELMET", "iron helmet", 5, 'common', 3, 16, "iron helmet: common quality, required level: 5, armor: 3, costs 16 gold")
steel_helmet = Armor("HELMET", "steel helmet", 7, 'rare', 4, 21, "steel helmet: rare quality, required level: 7, armor: 4, costs 21 gold")
...
leather_chest = Armor("CHEST", "leather chest", 3, 'common', 3, 15, "leather chest: common quality, required level: 3, armor: 3, costs 15 gold")
iron_chest = Armor("CHEST", "iron chest", 5, 'common', 4, 22, "iron chest: common quality, required level: 5, armor: 4, costs 22 gold")
steel_chest = Armor("CHEST", "steel chest", 7, 'rare', 5, 29, "steel chest: rare quality, required level: 7, armor: 5, costs 29 gold")
...
leather_gloves = Armor("GLOVES", "leather gloves", 3, 'common', 2, 9, "leather gloves: common quality, required level: 3, armor: 2, costs 9 gold")
iron_gloves = Armor("GLOVES", "iron gloves", 5, 'common', 3, 13, "iron gloves: common quality, required level: 5, armor: 3, costs 13 gold")
steel_gloves = Armor("GLOVES", "steel gloves", 7, 'rare', 4, 17, "steel gloves: rare quality, required level: 7, armor: 4, costs 17 gold")
...
leather_pants = Armor("PANTS", "leather pants", 3, 'common', 3, 13, "leather pants: common quality, required level: 3, armor: 3, costs 13 gold")
iron_pants = Armor("PANTS", "iron pants", 5, 'common', 4, 19, "iron pants: common quality, required level: 5, armor: 4, costs 19 gold")
steel_pants = Armor("PANTS", "steel pants", 7, 'rare', 5, 25, "steel pants: rare quality, required level: 7, armor: 5, costs 25 gold")
...
leather_boots = Armor("BOOTS", "leather boots", 3, 'common', 2, 11, "leather boots: common quality, required level: 3, armor: 2, costs 11 gold")
iron_boots = Armor("BOOTS", "iron boots", 5, 'common', 3, 16, "iron boots: common quality, required level: 5, armor: 3, costs 16 gold")
steel_boots = Armor("BOOTS", "steel boots", 7, 'rare', 4, 21, "steel boots: rare quality, required level: 7, armor: 4, costs 21 gold")
